...
3.  Create a data repository where instructors can freely access the data and use them in examples or their own lessons. Also, submit to existing data repositories. 
